		...
		btnBebekTekBaslat.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(selectedId==R.id.radioArama)
				{
					...
					//Toast.makeText(getApplicationContext(), "Arama se�ildi numara:"+txtNumara.getText(), Toast.LENGTH_SHORT).show();
				}
				else if(selectedId==R.id.radioSMS)
				{
					...
					//Toast.makeText(getApplicationContext(), "SMS se�ildi numara:"+txtNumara.getText(), Toast.LENGTH_SHORT).show();
